...
occfile<-"Tobler2015/occ_data_peru_6d.csv"
stationfile<-"Tobler2015/station_data_peru.csv"
...
modelFile='Tobler2015/MSRoyleNicholsMSOccJAGS.txt'
...
#Specify the model file, the file needs to be in the working directory
modelFile='Tobler2015/MSMSOccJAGS.txt'
