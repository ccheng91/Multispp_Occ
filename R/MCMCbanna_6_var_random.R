...
modelFile='R/model_6_var_random.txt'
...
#                        n.chains=3, n.iter=1000, n.adapt= 100, n.burnin=100, n.thin=1 )

fit <- jags(occ.data, occ.inits, occ.params, modelFile,     ## 
            n.chains=3, n.iter=500000, n.adapt= 10000, n.burnin=250000, n.thin=100, parallel = TRUE)
