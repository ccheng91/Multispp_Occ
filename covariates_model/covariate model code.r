...
data1 <- read.table("covariates_model/occ data.csv", header=TRUE,sep=",",na.strings=TRUE)
...
groups <- read.table("covariates_model/groups.csv", header=TRUE,sep=",",na.strings=c("NA"))
...
habitat <- read.table("covariates_model/habitat.csv", header=TRUE,sep=",",na.strings=c("NA"))
...
dates <- read.table("covariates_model/dates.csv", header=TRUE,sep=",",na.strings=c("NA"))
...
#sp.data = list("n", "nzeroes", "J", "K", "Xaug", "date1",
#               "date2", "ufc1", "ba1", "ufc2", 
#               "ba2", "Ind", "ground", "mid")
...
fit <- jags(sp.data, sp.inits, sp.params, "covarmodel.txt", 
